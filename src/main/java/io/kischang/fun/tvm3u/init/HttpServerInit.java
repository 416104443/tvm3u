package io.kischang.fun.tvm3u.init;
...
import io.kischang.fun.tvm3u.HttpServerTvM3uStarter;
...
public class HttpServerInit {
	...
	public static ServerTioConfig serverGroupContext;
	...
	public static void init() throws Exception {
		...
		requestHandler = new DefaultHttpRequestHandler(httpConfig, HttpServerTvM3uStarter.class);//第二个参数也可以是数组

		httpServerStarter = new HttpServerStarter(httpConfig, requestHandler);
		serverGroupContext = httpServerStarter.getServerTioConfig();
